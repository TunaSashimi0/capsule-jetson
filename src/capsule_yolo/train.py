...
from .config import DATA_YAML, PROJECT_ROOT


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train YOLO11n capsule counter.")
    ...
    parser.add_argument("--name", default="capsule_yolo11n", help="Run name.")
